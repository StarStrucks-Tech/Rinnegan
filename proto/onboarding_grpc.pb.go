...
const (
	OnboardingService_GiveConsent_FullMethodName = "/proto.OnboardingService/GiveConsent"
)
...
type OnboardingServiceClient interface {
	GiveConsent(ctx context.Context, in *ConsentRequest, opts ...grpc.CallOption) (*ConsentResponse, error)
}
...
func (c *onboardingServiceClient) GiveConsent(ctx context.Context, in *ConsentRequest, opts ...grpc.CallOption) (*ConsentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConsentResponse)
	err := c.cc.Invoke(ctx, OnboardingService_GiveConsent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OnboardingServiceServer interface {
	GiveConsent(context.Context, *ConsentRequest) (*ConsentResponse, error)
...
func (UnimplementedOnboardingServiceServer) GiveConsent(context.Context, *ConsentRequest) (*ConsentResponse, error) {
...
func _OnboardingService_GiveConsent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConsentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OnboardingServiceServer).GiveConsent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OnboardingService_GiveConsent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OnboardingServiceServer).GiveConsent(ctx, req.(*ConsentRequest))
	}
...
var OnboardingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.OnboardingService",
	HandlerType: (*OnboardingServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GiveConsent",
			Handler:    _OnboardingService_GiveConsent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/onboarding.proto",
}
