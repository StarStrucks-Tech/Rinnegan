...
// Define the Aadhar verification response message
type AadharVerificationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	OtpTransactionId string               `protobuf:"bytes,4,opt,name=otp_transaction_id,json=otpTransactionId,proto3" json:"otp_transaction_id,omitempty"`
	GeneratedOtp     string               `protobuf:"bytes,5,opt,name=generated_otp,json=generatedOtp,proto3" json:"generated_otp,omitempty"`
}

func (x *AadharVerificationResponse) Reset() {
	*x = AadharVerificationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AadharVerificationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AadharVerificationResponse) ProtoMessage() {}

func (x *AadharVerificationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AadharVerificationResponse.ProtoReflect.Descriptor instead.
func (*AadharVerificationResponse) Descriptor() ([]byte, []int) {
	return file_protos_frontend_onboarding_rpc_responses_proto_rawDescGZIP(), []int{6}
}

func (x *AadharVerificationResponse) GetRespHeader() *core.ResponseHeader {
	if x != nil {
		return x.RespHeader
	}
	return nil
...
func (x *AadharVerificationResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *AadharVerificationResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *AadharVerificationResponse) GetOtpTransactionId() string {
	if x != nil {
		return x.OtpTransactionId
	}
	return ""
}

func (x *AadharVerificationResponse) GetGeneratedOtp() string {
	if x != nil {
		return x.GeneratedOtp
	}
	return ""
}
...
var file_protos_frontend_onboarding_rpc_responses_proto_rawDesc = []byte{
	...
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xda, 0x01, 0x0a, 0x1a, 0x41, 0x61, 0x64, 0x68, 0x61,
	0x72, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x70, 0x5f, 0x68, 0x65,
	...
	,
...
var file_protos_frontend_onboarding_rpc_responses_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_protos_frontend_onboarding_rpc_responses_proto_goTypes = []any{
	...
	(*AadharVerificationResponse)(nil),          // 6: onboarding.AadharVerificationResponse
	(*core.ResponseHeader)(nil),                 // 7: core.ResponseHeader
	(enums.VerificationResponseType)(0),         // 8: enums.VerificationResponseType
	(enums.LivenessCheckStatus)(0),              // 9: enums.LivenessCheckStatus
	(enums.OnboardingStage)(0),                  // 10: enums.OnboardingStage
	(*deeplink.Deeplink)(nil),                   // 11: deeplink.Deeplink
}
var file_protos_frontend_onboarding_rpc_responses_proto_depIdxs = []int32{
	7,  // 0: onboarding.TriggerPhoneVerificationResponse.resp_header:type_name -> core.ResponseHeader
	8,  // 1: onboarding.TriggerPhoneVerificationResponse.response_type:type_name -> enums.VerificationResponseType
	7,  // 2: onboarding.TriggerPhoneOTPVerificationResponse.resp_header:type_name -> core.ResponseHeader
	8,  // 3: onboarding.TriggerPhoneOTPVerificationResponse.response_type:type_name -> enums.VerificationResponseType
	7,  // 4: onboarding.TriggerEmailVerificationResponse.resp_header:type_name -> core.ResponseHeader
	8,  // 5: onboarding.TriggerEmailVerificationResponse.response_type:type_name -> enums.VerificationResponseType
	7,  // 6: onboarding.TriggerPanVerificationResponse.resp_header:type_name -> core.ResponseHeader
	8,  // 7: onboarding.TriggerPanVerificationResponse.response_type:type_name -> enums.VerificationResponseType
	7,  // 8: onboarding.TriggerLivenessCheckResponse.resp_header:type_name -> core.ResponseHeader
	9,  // 9: onboarding.TriggerLivenessCheckResponse.liveness_check_status:type_name -> enums.LivenessCheckStatus
	7,  // 10: onboarding.GetCurrentOnboardingStageResponse.resp_header:type_name -> core.ResponseHeader
	10, // 11: onboarding.GetCurrentOnboardingStageResponse.current_stage:type_name -> enums.OnboardingStage
	11, // 12: onboarding.GetCurrentOnboardingStageResponse.next_action:type_name -> deeplink.Deeplink
	7,  // 13: onboarding.AadharVerificationResponse.resp_header:type_name -> core.ResponseHeader
...
func file_protos_frontend_onboarding_rpc_responses_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_protos_frontend_onboarding_rpc_responses_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*AadharVerificationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
